...
const publicLayout = layout => ({ registry: layout.registry, archive: layout.archive, tasks: layout.tasks, config: layout.config, attachmentsPrefix: layout.attachmentsPrefix, shared: layout.shared, dataBranch: layout.shared ? layout.pointer.branch : null });
